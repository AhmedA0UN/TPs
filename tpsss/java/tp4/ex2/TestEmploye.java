...
abstract class Commercial extends Employe {
    ...
    public Commercial(String nom, String prenom, int age, LocalDate dateEntree, double chiffreAffaire) {
...
class Vente extends Commercial {
    public Vente(String nom, String prenom, int age, LocalDate dateEntree, double chiffreAffaire) {
...
class Representation extends Commercial {
    public Representation(String nom, String prenom, int age, LocalDate dateEntree, double chiffreAffaire) {
        super(nom, prenom, age, dateEntree, chiffreAffaire);
    }
